            ...
            <div class="block">
                <el-carousel trigger="click" height="280px">
                    <el-carousel-item v-for="item in 2" :key="item" align="center">
                        <div class="introduce">
                            <p class="large-title">做一位医药守护者</p>
                            <p class="small-title">永远的坚持</p>
                            <p class="type-select">
                                <el-button type="success"><i class="fa fa-thumbs-up"></i>哈哈哈</el-button>
                                <el-button type="success"><i class="fa fa-star"></i>咻咻咻</el-button>
                            </p>
                        </div>
                    </el-carousel-item>
                </el-carousel>
